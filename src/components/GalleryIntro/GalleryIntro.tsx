    ...
    const images = [
        {
            ...
            alt: "Black and white fijian arm tattoo",
        },
        {
            src: "https://res.cloudinary.com/dnkzcvqxc/image/upload/v1753996248/2_vccbrw.jpg",
            alt: "Flying eagle arm tattoo in color",
        },
        {
            src: "https://res.cloudinary.com/dnkzcvqxc/image/upload/v1753996317/3_riy9mp.jpg",
            alt: "Black and white upper arm script tattoo",
        },
        {
            src: "https://res.cloudinary.com/dnkzcvqxc/image/upload/v1753996281/4_rdxqdh.jpg",
            alt: "Fijian - Polynesian arm tattoo in color",
        },
        {
            src: "https://res.cloudinary.com/dnkzcvqxc/image/upload/v1753996250/5_y61w7y.jpg",
            alt: "Blade and rose arm tattoo in color",
        },
        {
            src: "https://res.cloudinary.com/dnkzcvqxc/image/upload/v1753996320/6_twu4wp.jpg",
            alt: "Black and white upper arm script tattoo",
        },
        {
            src: "https://res.cloudinary.com/dnkzcvqxc/image/upload/v1753996285/7_shcp0a.jpg",
            alt: "Fijian - Polynesian arm tattoo in color",
        },
        {
            src: "https://res.cloudinary.com/dnkzcvqxc/image/upload/v1753996292/14_jd1q4m.png",
            alt: "Black and white stingray back tattoo ",
        },
        {
            src: "https://res.cloudinary.com/dnkzcvqxc/image/upload/v1753996287/9_axhsri.jpg",
            alt: "Fijian - Polynesian arm tattoo in color",
        },
        {
            src: "https://res.cloudinary.com/dnkzcvqxc/image/upload/v1753996325/10_kniiig.jpg",
            alt: "Black and white upper arm script tattoo",
        },
        {
            src: "https://res.cloudinary.com/dnkzcvqxc/image/upload/v1753996326/11_ndse1n.jpg",
            alt: "Black and white upper arm script tattoo",
        },
        {
            src: "https://res.cloudinary.com/dnkzcvqxc/image/upload/v1753996327/12_wfyurr.jpg",
            alt: "Black and white upper arm script tattoo",
        },
    ];
    ...
    return (
        ...
        <path className="fill-white dark:fill-[#FFD700]" fillOpacity="1" d="M0,160L1440,0L1440,0L0,0Z"></path>
            ...
            <div className="max-w-6xl mx-auto text-center">
                <h1
                    className="flex justify-center items-center font-subheading text-white dark:text-[#1C1C1C] py-10
            text-2xl
            sm:text-2xl
            md:text-2xl
            lg:text-3xl
            ...
            <div className="max-w-6xl mx-auto text-center">
                ...
                <button className="relative overflow-hidden rounded-full bg-black px-3 py-1 mt-6 text-white uppercase transition-all duration-200 ease-in-out hover:[--progress:0] cursor-pointer">
                    ...
                    <span className="mix-blend-difference relative z-10 text-base">
                        <Link
                            href="/tattoos"
                            className="flex justify-center items-center gap-2 mix-blend-difference relative z-10 text-base"
                        >
                            Stories in Skin
                            <svg
